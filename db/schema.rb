...
ActiveRecord::Schema[7.0].define(version: 20_230_912_012_438) do
  ...
  create_table 'continue_watchings', force: :cascade do |t|
    ...
    t.index %w[profile_id content_id episode_id], name: 'unique_continue_watchings_index', unique: true
