      ...
      <div>
        {currentUser ? (
          <Menu as="div" class="relative inline-block text-left">
            ...
            >
              <MenuItems class="user-menu-items before:backdrop-blur-2xl rounded-xl shadow-xl  p-8 flex flex-row min-w-[500px]">
                {/* Columna Mi cuenta */}
                <div class="flex-1 pr-8 border-r border-gray-700">
                  <div class="mb-4 text-xs text-gray-400 tracking-widest font-semibold">MI CUENTA</div>
                  <ul>
                    <li>
                      <router-link to="/help" class="menu-item">
                        <c-icon icon="help-circle" size={20} class="icon" />
                        <span class="ml-2">Ayuda</span>
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/devices" class="menu-item">
                        <c-icon icon="airplay" size={20} class="icon" />
                        <span class="ml-2">Dispositivos compatibles</span>
                      </router-link>
                    </li>
                    <li>
                      <router-link to="/account/preferences" class="menu-item">
                        <c-icon icon="settings" size={20} class="icon" />
                        <span class="ml-2">Cuenta y configuración</span>
                      </router-link>
                    </li>
                    <li>
