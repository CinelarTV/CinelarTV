  ...
  module Providers
    class BaseProvider
      ...
      def start_checkout(subscription:, return_url:)
        raise NotImplementedError, "start_checkout must be implemented"
      end

      def fetch_remote_subscription(subscription)
        raise NotImplementedError, "fetch_remote_subscription must be implemented"
      end

      def cancel(subscription)
        raise NotImplementedError, "cancel must be implemented"
      end
